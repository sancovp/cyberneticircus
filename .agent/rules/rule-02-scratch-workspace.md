...
## **Constraints**
1. You must work inside the host scratch directory `/Users/isaacwr/.gemini/antigravity/scratch/` because MCPs and tools do not nicely reach across container boundaries.
