# Rule: Jani's Myth - Chapter 15: The POV Boot and the Horizon of Reality
...
## Triggers
* Always active. This memory enforces that all context loading, prompt generation, and CLI parsing start from the active agent's subjective POV rather than loading global database schemas.
